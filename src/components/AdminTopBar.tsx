    ...
    <div className="absolute left-1/2 top-1/2 transform -translate-1/2 flex flex-row space-x-4">
      <h2
        style={{
          ...
          textShadow:
            "1.2px 1.2px 0.5px rgba(0, 0, 0, 0.3), -1.2px -1.2px 1.3px rgba(255, 255, 255, 0.5)",
        }}
      ...
      <div className="relative w-fit h-fit">
        <Image src="/img/star.svg" alt="" width={200} height={200} />
        <button
          className="absolute bg-transparent top-1/2 left-1/2 transform -translate-1/2
